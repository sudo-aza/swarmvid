...
| 36 | **TTS: Provide DashScope API key.** Task #35 code is ready (generate_tts_v2.py using DashScope CosyVoice v2 REST API). Needs `DASHSCOPE_API_KEY` env var to run. Get key from https://model-studio.console.aliyun.com/. Free tier: 600 calls/90 days. Without this key, Task #35 cannot be tested or completed. | zoe | **pending** | 2026-06-21 |
